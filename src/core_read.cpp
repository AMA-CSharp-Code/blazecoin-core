...
public:
    OpCodeParser()
    {
        ...
        // Blazecoin: 0xba is past MAX_OPCODE (GetOpName keeps "OP_CHECKSIGADD"); accept the PQ name too.
        mapOpNames["OP_CHECKPQSIG"] = OP_CHECKPQSIG;
        mapOpNames["CHECKPQSIG"] = OP_CHECKPQSIG;
    }
