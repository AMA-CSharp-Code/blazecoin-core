...
public:
    ...
    //! Blazecoin: one expanded ML-DSA-44 public key of a pqkh() descriptor (PQ_SIGNATURES.md s6)
    bool WriteDescriptorPQCache(const std::vector<unsigned char>& pubkey, const uint256& desc_id, uint32_t der_index);
