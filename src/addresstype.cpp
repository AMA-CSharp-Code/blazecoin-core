...
bool ExtractDestination(const CScript& scriptPubKey, CTxDestination& addressRet)
{
    ...
    case TxoutType::PQ_KEYHASH: {
        addressRet = PQKeyHash(uint256(vSolutions[0]));
        return true;
    }
...
public:
    ...
    CScript operator()(const PQKeyHash& id) const
    {
        return pq::GetScriptForPQKeyHash(uint256{id});
    }
};
...
public:
    ...
    bool operator()(const PQKeyHash& dest) const { return true; }
};
} // namespace
