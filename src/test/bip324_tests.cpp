...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    ...
    // Blazecoin: the *inputs* (keys, ellswift points, plaintexts, aad) are the upstream BIP324
    // vectors, but every derived value — session ids, garbage terminators, ciphertexts — was
    // re-derived 2026-07-06 under Blazecoin's mainnet network magic (fbc0b6db): the v2-transport
    // key derivation salts HKDF with "bitcoin_v2_shared_secret" + Params().MessageStart()
    // (bip324.cpp), so Bitcoin's published outputs can never match. Values were harvested from
    // this cipher implementation itself and are pinned here as regression vectors — they detect
    // future drift in the implementation or the network magic, not conformance with the BIP CSV.
    ...
    TestBIP324PacketVector(
        ...
        "",
        false,
        "8b256522a76758866326d16c2ef066ee",
        "893d3cbc54860c17da0ac5a1d6dc898d",
        "6f53155f95f7d973b495297cbc64d75f39732d80c3079fb2608f1a993c58014b",
        "a94f2519beb6e8623fa7af96e582118ad33ee25668",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "71adc131d7d7b1865a273ec530e077d0",
        "70926a1adc09d8dda9210dee34e9308b",
        "294a03aa5ba20d43d9a8e94de2a1117588449f549b78a8646c3e90e30124a243",
        "284a1ef99f87340453e3947e0f23d488e8ade804fe138739424514bb95f648ca353dfbc0a9",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "44fdf5ce116e7f0889cc3d99583573c8",
        "0e5b30b3f347d8c536a2b1dc1a25c0d2",
        "8f02c5c388c183fbf7971aaf3fde4f895a83b26e427e1dce971a9f1d4ec03e35",
        "3791b9302af9a89cc07be42e353848f4113da845ede940c064bf25eaeab20c9c9b4ca5bce1c95ed523a38d883a4a4818439a6360c7996612325691793e693f2b26243281be598ae2bd5b899d66a4227e3347e3",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "e4d6493c2f339bd2383bb2fafa1a8b17",
        "bd9beeec2673bb8c806e23ac599e157f",
        "9fd2bde754878a24cc692e26293d24097558d7ef2e7506bbeae12f909fc71758",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "5a413284385bcc06f53eafc72359442c",
        "6ffa687be6d3f02174f8a902946870f6",
        "fc418dabaea698923d369728e9688e2f3f89187f1be6671e1c5a6d0566201988",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "cebf15eb0a89e16a9637df1b5c09ea1c",
        "fa400bde49a327a92f15c81c272d7feb",
        "fb9845a8ceba888b792a94ee178bc31952cddca77b56bf803dede0008998d3bf",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "c65df2633972eab57e653f410027263f",
        "ebdc6e0876c22bd6e2e09ce428efee6f",
        "f78c856a1419756731b23f7da96a8aee3d5a247bbf6b9b0968db6300cbf2b5e8",
        "",
        "");
}
