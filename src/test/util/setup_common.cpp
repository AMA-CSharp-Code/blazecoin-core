    ...
    : TestingSetup{ChainType::REGTEST, opts}
{
    ...
    // Blazecoin reduced COINBASE_MATURITY to 30, and this fork's TestChain100Setup mines
    // COINBASE_MATURITY blocks (miner_tests / mempool_tests and others were adapted to that 30-block
    // chain). Tests that assumed the upstream 100-block chain were adapted down instead (interfaces_tests).
...

    {
        ...
        assert(
            ...
            "1b1effc2d895d20e744c1c4058b1ac23606bc5550cef73fa22a328dcedb025bc");
    }
}
