             ...
             std::map<std::vector<uint8_t>, std::vector<uint8_t>> preimages={})
{
    ...
    // Guard: a failed parse yields a null Descriptor; the checks below dereference parse_priv/parse_pub
    // unconditionally, so without this a bad vector (e.g. a key that no longer decodes) segfaults the
    // whole suite instead of reporting a clean failure.
    if (!parse_priv || !parse_pub) return;
...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    CheckUnparsable("pkh(deadbeef/1/2'/3/4']PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)", "pkh(deadbeef/1/2h/3/4h]03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "pkh(): Key origin start '[ character expected but not found, got 'd' instead"); // Missing start bracket in key origin
    CheckUnparsable("pkh([deadbeef]/1/2'/3/4']PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)", "pkh([deadbeef]/1/2'/3/4']03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "pkh(): Multiple ']' characters found for a single pubkey"); // Multiple end brackets in key origin

    // Basic single-key uncompressed
    Check("combo(6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt)", "combo(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", "combo(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)",SIGNABLE, {{"4104a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235ac","76a914b5bd079c4d57cc7fc28ecf8213a6b791625b818388ac"}}, std::nullopt, /*op_desc_id=*/uint256{"33f6bb5d32c04e9d9e5466a8212836743bd5466aa0b8d5331ce8aa0812371ffd"});
    Check("pk(6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt)", "pk(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", "pk(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", SIGNABLE, {{"4104a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235ac"}}, std::nullopt, /*op_desc_id=*/uint256{"52306fc1f5d0cb78aacea9d3933092be9252adc27b146f97c16a94d6fcdb652e"});
    Check("pkh(6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt)", "pkh(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", "pkh(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", SIGNABLE, {{"76a914b5bd079c4d57cc7fc28ecf8213a6b791625b818388ac"}}, OutputType::LEGACY, /*op_desc_id=*/uint256{"36657e8690d4015032da1a8c1e37b315c3f7ccb010e6ada12967878711962991"});
    CheckUnparsable("wpkh(6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt)", "wpkh(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", "wpkh(): Uncompressed keys are not allowed"); // No uncompressed keys in witness
    CheckUnparsable("wsh(pk(6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt))", "wsh(pk(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235))", "pk(): Uncompressed keys are not allowed"); // No uncompressed keys in witness
    CheckUnparsable("sh(wpkh(6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt))", "sh(wpkh(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235))", "wpkh(): Uncompressed keys are not allowed"); // No uncompressed keys in witness
    ...
    Check("sh(pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h))", "sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a9141857af51a5e516552b3086430fd8ce55f7c1a52487"}}, OutputType::LEGACY);
    Check("sh(pkh(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h))", "sh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "sh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a9141a31ad23bf49c247dd531a623c2ef57da3c400c587"}}, OutputType::LEGACY);
    Check("wsh(pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h))", "wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"00202e271faa2325c199d25d22e1ead982e45b64eeb4f31e73dbdf41bd4b5fec23fa"}}, OutputType::BECH32);
    Check("wsh(pkh(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h))", "wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"0020338e023079b91c58571b20e602d7805fb808c22473cbc391a41b1bd3a192e75b"}}, OutputType::BECH32);
    Check("sh(wsh(pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)))", "sh(wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "sh(wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", SIGNABLE, {{"a91472d0c5a3bfad8c3e7bd5303a72b94240e80b6f1787"}}, OutputType::P2SH_SEGWIT);
    Check("sh(wsh(pkh(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)))", "sh(wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "sh(wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", SIGNABLE, {{"a914b61b92e2ca21bac1e72a3ab859a742982bea960a87"}}, OutputType::P2SH_SEGWIT);
    Check("tr(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5,{pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5),{pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h),pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5)}})", "tr(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5,{pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5),{pk(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd),pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5)}})", "tr(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5,{pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5),{pk(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd),pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5)}})", XONLY_KEYS | SIGNABLE | MISSING_PRIVKEYS, {{"51201497ae16f30dacb88523ed9301bff17773b609e8a90518a3f96ea328a47d1500"}}, OutputType::BECH32M);
    ...
    Check("multi(1,PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h,6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt)", "multi(1,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", "multi(1,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", SIGNABLE, {{"512103a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd4104a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea23552ae"}}, std::nullopt, /*op_desc_id=*/uint256{"b147e25eb4a9d3da4e86ed8e970d817563ae2cb9c71a756b11cfdeb4dc11b70c"});
    Check("sortedmulti(1,PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h,6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt)", "sortedmulti(1,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", "sortedmulti(1,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", SIGNABLE, {{"512103a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd4104a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea23552ae"}}, std::nullopt, /*op_desc_id=*/uint256{"62b59d1e32a62176ef7a17538f3b80c7d1afc53e5644eb753525bdb5d556486c"});
    Check("sortedmulti(1,6C5vDVudCDZvkiyEUbAPPwXQbLPktmXtSbgpn5u2sBKx1NArUdt,PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)", "sortedmulti(1,04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "sortedmulti(1,04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"512103a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd4104a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea23552ae"}}, std::nullopt);
    ...
    Check("sh(wsh(multi(16,PqsZrGZyLanzf7J23QbciiPyHfLRmujUASZNHv9EyntRATePLwh6,PnLmrHuakQi8FiLLGpTJuaLyvcr8tUrG5pfGHf2qJvnSuRPN3pc1,Pot5Qu5mDwnVDQGVs4MrxVnGg7z5LSAN4mhETYHdFvKpHasMm7Ss,PsFsEqGqzyPWuCHLfx3d9mTjFDFsguRL4ZyURMWvMVrG5P1d4kdx,Prt9ATefL1Zq55sFhvnxe1xZEVaNjBCyeMnhkFpuMZ29jLspf5ix,PoHbEdoqf56pj2r3nJ6CzQde3Vd9phCQ2XSwDX3Mq57iLXqLhrbp,Pvj2GvdHLkSEQvrSokMhcSFvKspdvHXBsBqhkojQ8Vd5fYZKqTaz,PqKXLhcznBvksvB6emHBCFE2DWzw5RYfkyGn2vSMzADRVQnbPQn8,PtrgLoAhp2kdpte47WpHthoob6sGoRxEA9mMQTg6D8phwLT1TgFP,PpogfEU24kNH4DfjsU2dAMWLhj91Xft4JSSbNjV9MhoouEEvpUQY,Pnx4qUgp2TNxkMKqk5cGb5Wvzm1sWo8RfAw1nqXf2aG5UzuDGbtC,PqGsTU4khL8Gy6bdi8FdNym2D9BatCHYyuTx4q5AJ5Ghgotb93PR,PqmDDPKLRDAX62Y3rq2QNj1EeWFUPSAHRHTw5E8nDZGhUki19vNx,PpFvKbLT17MqQHVrz8cG3HPKu7RygULGA6VRCWayJ23LxsfGHhqa,PqNcWM6KrRDTeqNDQ94aoWeMTjLsRnDqvzQ3pSP7JjdtWcR9kA7x,Ps2zA4LNLreufD9Wz377VvrcaDC3YRaKK3Qw3MBuCCnzQRy2os6U)))","sh(wsh(multi(16,03669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0,0260b2003c386519fc9eadf2b5cf124dd8eea4c4e68d5e154050a9346ea98ce600,0362a74e399c39ed5593852a30147f2959b56bb827dfa3e60e464b02ccf87dc5e8,0261345b53de74a4d721ef877c255429961b7e43714171ac06168d7e08c542a8b8,02da72e8b46901a65d4374fe6315538d8f368557dda3a1dcf9ea903f3afe7314c8,0318c82dd0b53fd3a932d16e0ba9e278fcc937c582d5781be626ff16e201f72286,0297ccef1ef99f9d73dec9ad37476ddb232f1238aff877af19e72ba04493361009,02e502cfd5c3f972fe9a3e2a18827820638f96b6f347e54d63deb839011fd5765d,03e687710f0e3ebe81c1037074da939d409c0025f17eb86adb9427d28f0f7ae0e9,02c04d3a5274952acdbc76987f3184b346a483d43be40874624b29e3692c1df5af,02ed06e0f418b5b43a7ec01d1d7d27290fa15f75771cb69b642a51471c29c84acd,036d46073cbb9ffee90473f3da429abc8de7f8751199da44485682a989a4bebb24,02f5d1ff7c9029a80a4e36b9a5497027ef7f3e73384a4a94fbfe7c4e9164eec8bc,02e41deffd1b7cce11cde209a781adcffdabd1b91c0ba0375857a2bfd9302419f3,02d76625f7956a7fc505ab02556c23ee72d832f1bac391bcd2d3abce5710a13d06,0399eb0a5487515802dc14544cf10b3666623762fbed2ec38a3975716e2c29c232)))", "sh(wsh(multi(16,03669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0,0260b2003c386519fc9eadf2b5cf124dd8eea4c4e68d5e154050a9346ea98ce600,0362a74e399c39ed5593852a30147f2959b56bb827dfa3e60e464b02ccf87dc5e8,0261345b53de74a4d721ef877c255429961b7e43714171ac06168d7e08c542a8b8,02da72e8b46901a65d4374fe6315538d8f368557dda3a1dcf9ea903f3afe7314c8,0318c82dd0b53fd3a932d16e0ba9e278fcc937c582d5781be626ff16e201f72286,0297ccef1ef99f9d73dec9ad37476ddb232f1238aff877af19e72ba04493361009,02e502cfd5c3f972fe9a3e2a18827820638f96b6f347e54d63deb839011fd5765d,03e687710f0e3ebe81c1037074da939d409c0025f17eb86adb9427d28f0f7ae0e9,02c04d3a5274952acdbc76987f3184b346a483d43be40874624b29e3692c1df5af,02ed06e0f418b5b43a7ec01d1d7d27290fa15f75771cb69b642a51471c29c84acd,036d46073cbb9ffee90473f3da429abc8de7f8751199da44485682a989a4bebb24,02f5d1ff7c9029a80a4e36b9a5497027ef7f3e73384a4a94fbfe7c4e9164eec8bc,02e41deffd1b7cce11cde209a781adcffdabd1b91c0ba0375857a2bfd9302419f3,02d76625f7956a7fc505ab02556c23ee72d832f1bac391bcd2d3abce5710a13d06,0399eb0a5487515802dc14544cf10b3666623762fbed2ec38a3975716e2c29c232)))", SIGNABLE, {{"a9147fc63e13dc25e8a95a3cee3d9a714ac3afd96f1e87"}}, OutputType::P2SH_SEGWIT, /*op_desc_id=*/std::nullopt);
    Check("tr(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h,pk(PqsZrGZyLanzf7J23QbciiPyHfLRmujUASZNHv9EyntRATePLwh6))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,pk(669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,pk(669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0))", SIGNABLE | XONLY_KEYS, {{"512017cf18db381d836d8923b1bdb246cfcd818da1a9f0e6e7907f187f0b2f937754"}}, OutputType::BECH32M, /*op_desc_id=*/uint256{"af482b44c10b737b678e1091584818372e169e2dc5219e2877fabe1b83ae467b"});
    Check("tr(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h,multi_a(1,PqsZrGZyLanzf7J23QbciiPyHfLRmujUASZNHv9EyntRATePLwh6))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,multi_a(1,669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,multi_a(1,669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0))", SIGNABLE | XONLY_KEYS, {{"5120eb5bd3894327d75093891cc3a62506df7d58ec137fcd104cdd285d67816074f3"}}, OutputType::BECH32M);
    CheckUnparsable("sh(multi(16,PqsZrGZyLanzf7J23QbciiPyHfLRmujUASZNHv9EyntRATePLwh
03669b8afcec803a0d323e9a17f3ea8e68e8abe5a278020a929adbec52421adbd0,0260b2003c386519fc9eadf2b5cf124dd8eea4c4e68d5e154050a9346ea98ce600,0362a74e399c39ed5593852a30147f2959b56bb827dfa3e60e464b02ccf87dc5e8,0261345b53de74a4d721ef877c255429961b7e43714171ac06168d7e08c542a8b8,02da72e8b46901a65d4374fe6315538d8f368557dda3a1dcf9ea903f3afe7314c8,0318c82dd0b53fd3a932d16e0ba9e278fcc937c582d5781be626ff16e201f72286,0297ccef1ef99f9d73dec9ad37476ddb232f1238aff877af19e72ba04493361009,02e502cfd5c3f972fe9a3e2a18827820638f96b6f347e54d63deb839011fd5765d,03e687710f0e3ebe81c1037074da939d409c0025f17eb86adb9427d28f0f7ae0e9,02c04d3a5274952acdbc76987f3184b346a483d43be40874624b29e3692c1df5af,02ed06e0f418b5b43a7ec01d1d7d27290fa15f75771cb69b642a51471c29c84acd,036d46073cbb9ffee90473f3da429abc8de7f8751199da44485682a989a4bebb24,02f5d1ff7c9029a80a4e36b9a5497027ef7f3e73384a4a94fbfe7c4e9164eec8bc,02e41deffd1b7cce11cde209a781adcffdabd1b91c0ba0375857a2bfd9302419f3,02d76625f7956a7fc505ab02556c23ee72d832f1bac391bcd2d3abce5710a13d06,0399eb0a5487515802dc14544cf10b3666623762fbed2ec38a3975716e2c29c232,02bc2feaa536991d269aae46abb8f3772a5b3ad592314945e51543e7da84c4af6e,0318bf32e5217c1eb771a6d5ce1cd39395dff7ff665704f175c9a5451d95a2f2ca,02c681a6243f16208c2004bb81f5a8a67edfdd3e3711534eadeec3dcf0b010c759,0249fdd6b69768b8d84b4893f8ff84b36835c50183de20fcae8f366a45290d01fd)))", SIGNABLE, {{"a914c2c9c510e9d7f92fd6131e94803a8d34a8ef675e87"}}, OutputType::P2SH_SEGWIT, /*op_desc_id=*/uint256{"69c3f3153ed2527d12cf78e53e719233fdb7fa6ca9f8a10059ce47d34b49c4cb"}); // Even if it's wrapped into P2SH
    // Check for invalid nesting of structures
    CheckUnparsable("sh(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)", "sh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "A function is needed within P2SH"); // P2SH needs a script, not a key
    CheckUnparsable("sh(combo(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h))", "sh(combo(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "Can only have combo() at top level"); // Old must be top level
    CheckUnparsable("wsh(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)", "wsh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "A function is needed within P2WSH"); // P2WSH needs a script, not a key
    CheckUnparsable("wsh(wpkh(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h))", "wsh(wpkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "Can only have wpkh() at top level or inside sh()"); // Cannot embed witness inside witness
    CheckUnparsable("wsh(sh(pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)))", "wsh(sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "Can only have sh() at top level"); // Cannot embed P2SH inside P2WSH
    CheckUnparsable("sh(sh(pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)))", "sh(sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "Can only have sh() at top level"); // Cannot embed P2SH inside P2SH
    CheckUnparsable("wsh(wsh(pk(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)))", "wsh(wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "Can only have wsh() at top level or inside sh()"); // Cannot embed P2WSH inside P2WSH
    ...
    Check(
        "rawtr(PuvhtAbGkWULFzFCUmnRrFfD8YbSjVZL3z6mszcfEUadnTuVwF1h)",
    ...
    Check("tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,thresh(2,pk(PrSiDKzsi1WeNEHCEk1EFP77z3PXGLwwAFWjNaLhMh2Lb1gxEZz4),s:pk(Pq874PLRqN5xQeuUbqRaUJf1igAoL6rc97gkhUwDcoiPVN7UQVKw),adv:older(42)))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,thresh(2,pk(30a6069f344fb784a2b4c99540a91ee727c91e3a25ef6aae867d9c65b5f23529),s:pk(9918d400c1b8c3c478340a40117ced4054b6b58f48cdb3c89b836bdfee1f5766),adv:older(42)))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,thresh(2,pk(30a6069f344fb784a2b4c99540a91ee727c91e3a25ef6aae867d9c65b5f23529),s:pk(9918d400c1b8c3c478340a40117ced4054b6b58f48cdb3c89b836bdfee1f5766),adv:older(42)))", MISSING_PRIVKEYS | XONLY_KEYS | SIGNABLE, {{"512033982eebe204dc66508e4b19cfc31b5ffc6e1bfcbf6e5597dfc2521a52270795"}}, OutputType::BECH32M);
    // Can have a pkh() expression alone as tr() script path (because pkh() is valid Miniscript).
    Check("tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,pkh(PrSiDKzsi1WeNEHCEk1EFP77z3PXGLwwAFWjNaLhMh2Lb1gxEZz4))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,pkh(30a6069f344fb784a2b4c99540a91ee727c91e3a25ef6aae867d9c65b5f23529))", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,pkh(30a6069f344fb784a2b4c99540a91ee727c91e3a25ef6aae867d9c65b5f23529))", MISSING_PRIVKEYS | XONLY_KEYS | SIGNABLE, {{"51201e9875f690f5847404e4c5951e2f029887df0525691ee11a682afd37b608aad4"}}, OutputType::BECH32M);
    // Can have a Miniscript expression under tr() if it's part of a tree.
    Check("tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,{{pkh(PppsFxnTh5vpPvmxjSuRcgD2pmNA5JZsrLbAVraPSC7Jiwro6RLr),pk(PtKBr4P7ogHQPgN2y6k2TYCqTPqLTs6TMWixMzKezUbPZTyERQVU)},thresh(1,pk(PrSiDKzsi1WeNEHCEk1EFP77z3PXGLwwAFWjNaLhMh2Lb1gxEZz4),s:pk(Pq874PLRqN5xQeuUbqRaUJf1igAoL6rc97gkhUwDcoiPVN7UQVKw))})", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,{{pkh(1c9bc926084382e76da33b5a52d17b1fa153c072aae5fb5228ecc2ccf89d79d5),pk(0dd6b52b192ab195558d22dd8437a9ec4519ee5ded496c0d55bc9b1a8b0e8c2b)},thresh(1,pk(30a6069f344fb784a2b4c99540a91ee727c91e3a25ef6aae867d9c65b5f23529),s:pk(9918d400c1b8c3c478340a40117ced4054b6b58f48cdb3c89b836bdfee1f5766))})", "tr(a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,{{pkh(1c9bc926084382e76da33b5a52d17b1fa153c072aae5fb5228ecc2ccf89d79d5),pk(0dd6b52b192ab195558d22dd8437a9ec4519ee5ded496c0d55bc9b1a8b0e8c2b)},thresh(1,pk(30a6069f344fb784a2b4c99540a91ee727c91e3a25ef6aae867d9c65b5f23529),s:pk(9918d400c1b8c3c478340a40117ced4054b6b58f48cdb3c89b836bdfee1f5766))})", MISSING_PRIVKEYS | XONLY_KEYS, {{"5120d8ea39b29de2b550b68bd2ada8b075c888c2b2df3290c7a35856482747848934"}}, OutputType::BECH32M);
    ...
    CheckInferDescriptor("76a91445ff7c2327866472639d507334a9a00119dfd32688ac", "addr(BaAoHTpahiTPtZbD46EJzF5E1qxD5reCFd)", {}, {{"069228de6902abb4f541791f6d7f925b10e2078ccb1298856e5ea5cc5fd667f930eac37a00cc07f9a91ef3c2d17bf7a17db04552ff90ac312a5b8b4caca6c97aa4", ""}});
    // p2wpkh script with uncompressed key must infer as addr()
    CheckInferDescriptor("001422e363a523947a110d9a9eb114820de183aca313", "addr(blz1qyt3k8ffrj3apzrv6n6c3fqsduxp6egcnvw2920)", {}, {{"049228de6902abb4f541791f6d7f925b10e2078ccb1298856e5ea5cc5fd667f930eac37a00cc07f9a91ef3c2d17bf7a17db04552ff90ac312a5b8b4caca6c97aa4", ""}}); // Blazecoin bech32 HRP is blz (was bc)
...
BOOST_AUTO_TEST_CASE(descriptor_pqkh_blazecoin)
{
    // Blazecoin P2PQH descriptors (PQ_SIGNATURES.md s6), pinned to the test/pqsig derivation vectors.
    namespace V = pqsig_vectors;
    const std::string seed_hex = V::DERIVATION[0].master_seed;
    const std::string prv = "pqkh(mldsa44:" + seed_hex + "/*)";

    FlatSigningProvider keys_priv;
    std::string error;
    auto parse_priv = Parse(prv, keys_priv, error);
    BOOST_REQUIRE_MESSAGE(parse_priv, error);
    BOOST_CHECK_EQUAL(keys_priv.keys.size(), 1U); // the seed, filed under its marker pubkey id
    BOOST_CHECK(parse_priv->IsRange());
    BOOST_CHECK(parse_priv->IsSolvable());
    BOOST_CHECK(parse_priv->IsSingleType());
    BOOST_CHECK(parse_priv->GetOutputType() == OutputType::PQ);
    BOOST_CHECK_EQUAL(*parse_priv->ScriptSize(), 34);
    BOOST_CHECK_EQUAL(*parse_priv->MaxSatisfactionWeight(true), 3739 * 4);
    BOOST_CHECK_EQUAL(*parse_priv->MaxSatisfactionWeight(false), 3739 * 4);
    BOOST_CHECK_EQUAL(*parse_priv->MaxSatisfactionElems(), 2);

    // Public form: the 20-byte seed id, never the seed; checksummed; parses back to the same descriptor id.
    const std::string pub = parse_priv->ToString();
    BOOST_CHECK_EQUAL(pub.substr(0, 13), "pqkh(mldsa44:");
    BOOST_CHECK_EQUAL(pub.find("/*)#"), 13 + 40);
    BOOST_CHECK(pub.find(seed_hex) == std::string::npos);
    const CKeyID seed_id = keys_priv.keys.begin()->first;
    BOOST_CHECK_EQUAL(pub.substr(13, 40), HexStr(seed_id));
    BOOST_CHECK_EQUAL(GetDescriptorChecksum(pub), pub.substr(pub.find('#') + 1));
    FlatSigningProvider keys_pub;
    auto parse_pub = Parse(pub, keys_pub, error, /*require_checksum=*/true);
    BOOST_REQUIRE_MESSAGE(parse_pub, error);
    BOOST_CHECK(keys_pub.keys.empty());
    BOOST_CHECK_EQUAL(parse_pub->ToString(), pub);
    BOOST_CHECK(DescriptorID(*parse_priv) == DescriptorID(*parse_pub));
    BOOST_CHECK(parse_pub->IsRange());

    // Private string round trip needs the seed.
    std::string prv_out;
    BOOST_CHECK(parse_priv->ToPrivateString(keys_priv, prv_out));
    BOOST_CHECK_EQUAL(prv_out.substr(0, prv_out.find('#')), prv);
    BOOST_CHECK(parse_pub->ToPrivateString(keys_priv, prv_out));
    BOOST_CHECK_EQUAL(prv_out.substr(0, prv_out.find('#')), prv);
    BOOST_CHECK(!parse_priv->ToPrivateString(keys_pub, prv_out));
    std::string norm;
    BOOST_CHECK(parse_priv->ToNormalizedString(keys_priv, norm));
    BOOST_CHECK_EQUAL(norm, pub);

    // Expansion matches the vectors at every index; the cache captures the public keys.
    DescriptorCache cache;
    for (size_t i = 0; i < V::DERIVATION_COUNT; ++i) {
        const auto& d = V::DERIVATION[i];
        std::vector<CScript> scripts;
        FlatSigningProvider out;
        BOOST_REQUIRE(parse_priv->Expand(d.index, keys_priv, scripts, out, &cache));
        BOOST_REQUIRE_EQUAL(scripts.size(), 1U);
        BOOST_CHECK_EQUAL(HexStr(scripts[0]), d.scriptPubKey);
        BOOST_REQUIRE_EQUAL(out.pq_keys.size(), 1U);
        const auto& [pqkh, key] = *out.pq_keys.begin();
        BOOST_CHECK_EQUAL(HexStr(pqkh), d.pqkh);
        BOOST_CHECK_EQUAL(HexStr(key.pubkey), d.pubkey);
        BOOST_CHECK(key.seckey.empty()); // Expand never reveals the secret
        BOOST_CHECK(out.keys.empty());

        FlatSigningProvider priv_out;
        parse_priv->ExpandPrivate(d.index, keys_priv, priv_out);
        BOOST_REQUIRE_EQUAL(priv_out.pq_keys.size(), 1U);
        BOOST_CHECK_EQUAL(priv_out.pq_keys.begin()->second.seckey.size(), 2560U);
        BOOST_CHECK_EQUAL(priv_out.keys.size(), 1U);
        FlatSigningProvider nothing;
        parse_priv->ExpandPrivate(d.index, keys_pub, nothing);
        BOOST_CHECK(nothing.pq_keys.empty());

        // The public form cannot expand without the seed, but can from the cache.
        BOOST_CHECK(!parse_pub->Expand(d.index, keys_pub, scripts, out));
        std::vector<CScript> cached_scripts;
        FlatSigningProvider cached_out;
        BOOST_REQUIRE(parse_pub->ExpandFromCache(d.index, cache, cached_scripts, cached_out));
        BOOST_CHECK_EQUAL(HexStr(cached_scripts[0]), d.scriptPubKey);
        BOOST_CHECK_EQUAL(cached_out.pq_keys.size(), 1U);
    }
    BOOST_CHECK_EQUAL(cache.GetCachedPQPubKeys().size(), V::DERIVATION_COUNT);
    {
        // MergeAndDiff carries PQ pubkeys and reports only what was new.
        DescriptorCache merged;
        DescriptorCache diff = merged.MergeAndDiff(cache);
        BOOST_CHECK_EQUAL(diff.GetCachedPQPubKeys().size(), V::DERIVATION_COUNT);
        BOOST_CHECK_EQUAL(merged.MergeAndDiff(cache).GetCachedPQPubKeys().size(), 0U);
        std::vector<CScript> scripts;
        FlatSigningProvider out;
        BOOST_CHECK(!parse_pub->ExpandFromCache(V::DERIVATION_COUNT + 5, cache, scripts, out));
    }

    // Single public form: what InferDescriptor produces, and a watch-only importable single address.
    const std::string single = std::string("pqkh(mldsa44pub:") + V::DERIVATION[0].pubkey + ")";
    FlatSigningProvider keys_single;
    auto parse_single = Parse(single, keys_single, error);
    BOOST_REQUIRE_MESSAGE(parse_single, error);
    BOOST_CHECK(!parse_single->IsRange());
    BOOST_CHECK(parse_single->IsSolvable());
    BOOST_CHECK(parse_single->GetOutputType() == OutputType::PQ);
    BOOST_CHECK_EQUAL(parse_single->ToString().substr(0, single.size()), single);
    std::vector<CScript> single_scripts;
    FlatSigningProvider single_out;
    BOOST_REQUIRE(parse_single->Expand(0, keys_single, single_scripts, single_out));
    BOOST_CHECK_EQUAL(HexStr(single_scripts[0]), V::DERIVATION[0].scriptPubKey);
    BOOST_CHECK(parse_single->ToPrivateString(keys_single, prv_out)); // nothing private to add
    {
        FlatSigningProvider provider;
        parse_priv->Expand(0, keys_priv, single_scripts, provider);
        auto inferred = InferDescriptor(single_scripts[0], provider);
        BOOST_REQUIRE(inferred);
        BOOST_CHECK_EQUAL(inferred->ToString(), parse_single->ToString());
        auto unknown = InferDescriptor(single_scripts[0], DUMMY_SIGNING_PROVIDER);
        BOOST_REQUIRE(unknown);
        BOOST_CHECK(!unknown->IsSolvable());
        BOOST_CHECK_EQUAL(unknown->ToString().substr(0, 5), "addr(");
    }

    // Rejections.
    struct Bad { std::string desc; std::string err; };
    const std::vector<Bad> bad{
        {"pqkh(mldsa44:" + seed_hex + ")", "pqkh(): mldsa44 seed form must be ranged (end with /*)"},
        {"pqkh(mldsa44:abcd/*)", "pqkh(): mldsa44 seed must be 32 bytes (private) or a 20-byte seed id (public)"},
        {"pqkh(mldsa44:zz/*)", "pqkh(): seed is not hex"},
        {"pqkh(mldsa44pub:00)", "pqkh(): mldsa44pub key must be 1312 hex bytes"},
        {"pqkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "pqkh(): key must be mldsa44:<seed>/* or mldsa44pub:<pubkey>"},
        {"sh(pqkh(mldsa44:" + seed_hex + "/*))", "Can only have pqkh() at top level"},
        {"wsh(pqkh(mldsa44:" + seed_hex + "/*))", "Can only have pqkh() at top level"},
    };
    for (const auto& b : bad) {
        FlatSigningProvider k;
        std::string e;
        BOOST_CHECK_MESSAGE(!Parse(b.desc, k, e), b.desc);
        BOOST_CHECK_EQUAL(e, b.err);
    }
}
