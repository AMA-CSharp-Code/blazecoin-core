...
UniValue DeploymentInfo(const CBlockIndex* blockindex, const ChainstateManager& chainman)
{
    ...
    SoftForkDescPushBack(blockindex, softforks, chainman, Consensus::DEPLOYMENT_PHOENIX413); // Blazecoin Era 3
    SoftForkDescPushBack(blockindex, softforks, chainman, Consensus::DEPLOYMENT_PQSIG); // Blazecoin P2PQH (hard fork by flag height)
