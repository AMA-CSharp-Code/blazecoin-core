...
// Blazecoin proprietary input fields (PQ_SIGNATURES.md s6): key = 0xFC <compact 3> "blz" <compact subtype>
static const std::vector<unsigned char> PSBT_BLZ_IDENTIFIER{'b', 'l', 'z'};
static constexpr uint8_t PSBT_BLZ_PQ_SIG = 0x01;     //!< value: the ML-DSA-44 signature (2,420 bytes) of a P2PQH input
static constexpr uint8_t PSBT_BLZ_PQ_KEYBLOB = 0x02; //!< value: the key blob algo_id || pubkey (1,313 bytes) of a P2PQH input
