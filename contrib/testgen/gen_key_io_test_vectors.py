...
# key types
# Blazecoin: mainnet P2PKH version is 26 ('B' addresses) and WIF is 154 (128 + 26);
# P2SH (5) and the testnet/signet/regtest prefixes are Bitcoin-identical.
PUBKEY_ADDRESS = 26
SCRIPT_ADDRESS = 5
...
# Blazecoin HRPs: mainnet 'blz', testnet3 'tblz', signet 'tb' (unchanged), regtest 'bcrt'.
bech32_templates = [
  # hrp, version, witprog_size, metadata, encoding, output_prefix
  ('blz',   0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('blz',   0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('blz',   1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('blz',   2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tblz',  0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tblz',  0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tblz',  1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tblz',  3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
...
bech32_ng_templates = [
  ...
  ('tblz', 17, 32, Encoding.BECH32M, False, False, False),
  ('bcrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('blz',  15, 41, Encoding.BECH32M, False, False, False),
  ('tblz',  0, 16, Encoding.BECH32,  False, False, False),
  ('bcrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('blz',   0, 16, Encoding.BECH32,  True,  False, False),
  ('tblz',  0, 32, Encoding.BECH32,  False, True,  False),
  ('bcrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('blz',   0, 20, Encoding.BECH32M, False, False, False),
  ('tblz',  0, 32, Encoding.BECH32M, False, False, False),
  ('bcrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('blz',   1, 32, Encoding.BECH32,  False, False, False),
  ('tblz',  2, 16, Encoding.BECH32,  False, False, False),
...
def is_valid_bech32(v):
    ...
    # Blazecoin HRPs (signet/testnet4 kept Bitcoin's 'tb')
    for hrp in ['blz', 'tblz', 'tb', 'bcrt']:
